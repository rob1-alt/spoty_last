...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DGZH4wcbDP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'notion_base_url': $value = $this->getEnv('resolve:NOTION_BASE_URL'); break;
            case 'notion_token': $value = $this->getEnv('resolve:NOTION_TOKEN'); break;
